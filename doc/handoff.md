...
GET    /products/{sku}/sizes
  ...
  -- client computes display label as: fabric_variant_name != null ? "{size_label} · {fabric_variant_name}"
  --   : size_label — this is a client-side presentational concern, not a stored field
