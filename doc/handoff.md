...
|---|---|---|---|
| v3.33 | 2026-08-26 | Frontend | **PLANNED: Tampilan Preload Peringatan Stok di Dashboard.** Menambahkan skeleton loader/preload view berukuran presisi (`height: 46`, `width: 260`) di seksi Peringatan Stok BerandaView saat loading (`isLoading` bernilai true). Hal ini mencegah layout shift (pergeseran letak) yang membuat seksi Kasir Penjualan Kilat meloncat turun setelah data selesai dimuat. Rincian spesifikasi: `doc/versions/v3.33.md`. |
