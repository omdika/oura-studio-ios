...
|---|---|---|---|
| v3.51 | 2026-09-07 | Fullstack | **PLANNED: Shopee Bulk Upload Excel Generator.** Menyusun rencana arsitektur export produk ke format `.xlsx` Mass Upload Shopee untuk kategori Scrunchie (kode: 100146) dan Pouch (kode: 101650), pengosongan merek, default berat/dimensi, refaktor penambahan kategori produk di frontend & database, serta Share Sheet integration di iOS. Rincian spesifikasi: `doc/versions/v3.51.md`. |
